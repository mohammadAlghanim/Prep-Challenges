...
const objLat = (obj) => {
    ...
    const firstName = obj.firstName[0].toUpperCase() + obj.firstName.slice(1).toLowerCase();
  const lastName = obj.lastName[0].toUpperCase() + obj.lastName.slice(1).toLowerCase();
